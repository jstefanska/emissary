...
from tests.unit.utils import econf_foreach_hcm, module_and_mapping_manifests
...
def test_all_listener_common_http_protocol_options():
    yaml = module_and_mapping_manifests(["headers_with_underscores_action: DROP_HEADER", "listener_idle_timeout_ms: 4005"], [])
    _test_listener_common_http_protocol_options(yaml, expectations={
